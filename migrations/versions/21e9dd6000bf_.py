...
Revision ID: 21e9dd6000bf
Revises: 
Create Date: 2023-11-17 20:40:11.123886
...
def upgrade():
    ...
    sa.Column('connect_type', sa.Integer(), nullable=True),
    sa.Column('connect_link', sa.String(length=128), nullable=False),
    sa.ForeignKeyConstraint(['connect_type'], ['connect_type.id'], ),
